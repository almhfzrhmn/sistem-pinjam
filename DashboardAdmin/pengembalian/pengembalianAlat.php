...
$dataPengembalian = queryReadData("SELECT pengembalian.id_pengembalian, pengembalian.id_alat, alat_olahraga.nama_alat, alat_olahraga.kategori, pengembalian.nisn, member.nama, member.kelas, member.jurusan, admin.nama_admin, pengembalian.alat_kembali, pengembalian.keterlambatan, pengembalian.denda
FROM pengembalian
...
<head>
  ...
  <title>Kelola pengembalian alat olahraga || admin</title>
</head>
<body>
      ...
      <table class="table table-striped table-hover">
        <thead class="text-center">
          <tr>
            ...
            <th class="bg-primary text-light">Alat Kembali</th>
