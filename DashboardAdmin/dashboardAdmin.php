...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard SportBorrowing</div>
      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
          <a href="member/member.php">
            <img src="../assets/dashboardCardMember/MEMBER.png" alt="daftar member" style="max-width: 100%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
        ...
        <div class="cardImg">
          <a href="peminjaman/peminjamanAlat.php">
            <img src="../assets/dashBoardCardMember/PEMINJAMAN.png" alt="daftar peminjaman" style="max-width: 100%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
          <a href="pengembalian/pengembalianAlat.php">
          <img src="../assets/dashBoardCardMember/PENGEMBALIAN.png" alt="daftar pengembalian" style="max-width: 100%;" width="600px">
          </a>
        </div>
