...
$dataPinjam = queryReadData("SELECT peminjaman.id_peminjaman, peminjaman.id_alat, alat_olahraga.nama_alat, peminjaman.nisn, member.nama, admin.nama_admin, peminjaman.tgl_peminjaman, peminjaman.tgl_pengembalian
FROM peminjaman
...
<head>
  ...
  <title>Transaksi Peminjaman Alat || Member</title>
</head>
<body>
  ...
  <div class="p-4 mt-5">
    <div class="mt-5 alert alert-primary" role="alert">Riwayat transaksi Peminjaman Alat Anda - <span class="fw-bold text-capitalize"><?php echo htmlentities($_SESSION["member"]["nama"]); ?></span></div>
      ...
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-success" href="pengembalianAlat.php?id=<?= $item["id_peminjaman"]; ?>"> Kembalikan</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
